...
### EDA
#### [Count by Zipcode](./Questions/Question1.ipynb)
   <img src='images/mapwithcountss.png' width='80%'/> 

#### [Price by Zipcode](./Questions/Question1.ipynb)
...
### EDA
#### [Distance from closest city v Price](./Questions/Question2.ipynb)
   <img src='images/distancexprice.png' width='80%'/>

#### [Price v Size](./Questions/Question2.ipynb)
   <img src='images/pricexsize.png' width='80%'/>

#### [Distance from biggest city (Seattle) v Size](./Questions/Question2.ipynb)
...
### EDA
#### [Price v Waterfront Properties](./Questions/Question3.ipynb)
...
### Recommendation
Investing in waterfront properties would definitely be a smart move especially given there's a difference of $1 million between the average home prices of a waterfront and no waterfront property.
...
# [Final Model](./models/final.ipynb)
For the first model the independent variables I used were:
   * Grade
   * Area of inside home
   * Area of parking lot
